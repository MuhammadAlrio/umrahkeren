...
<style>.original-price {
  ...
  color: #6c757d; /* Warna teks doff (abu-abu) */
  margin-right: 10px; /* Memberikan jarak antara harga yang dicoret dan harga baru */
}</style>
  </head>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"> <img class="d-inline-block align-top img-fluid" src="assets/img/gallery/logoumrah.png" alt="" width="200" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <form action="login.php" method="get" class="ps-lg-5">
            <div class="user-info">
              ...
              <?php else: ?>
                ...
                <button class="btn btn-lg btn-outline-primary order-0" type="submit">Login</button>
                    <?php endif; ?>
                    </div>          
          </div>
          </form>
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/illustrations/hero1.png);background-position:right center;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
              <h1 class="mb-4 display-1 lh-sm">Umrah Keren </h1>
              <p class="mt-4 mb-5 fs-1 lh-base">Jadikan umrah Anda lebih bermakna, <br class="d-none d-lg-block" />Bersama mengukir Jejak ditanah Suci <br class="d-none d-lg-block" /></p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row flex-md-center">
            <div class="col-md-11 col-lg-4 py-md-3 px-4 px-md-3 px-lg-0 px-xl-2 order-lg-1">
              <h1 class="fw-bold fs-md-3 fs-xl-5">Rasakan Perjalanan Umrah yang Berkesan</h1>
              <p class="lh-lg">Temukan paket umrah terbaik dengan fasilitas lengkap dan destinasi eksklusif. Nikmati pengalaman spiritual yang tak terlupakan bersama kami.</p><a class="btn btn-lg btn-primary hover-top" href="sistem.php" role="button">Lihat Paket</a>
            </div>
              ...
              <div class="carousel slide" id="carouselExampleControlsNoTouching" data-bs-touch="false" data-bs-interval="false">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <div class="row h-100">
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/img/paketjanuari.jpg" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge costum-badge">RP.33.000.000</span></div>                          
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                              <h5 class="text-white">Umroh Januari</h5>
                              <h6 class="text-600">9 days</h6>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/img/paketfebuari.jpg" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3">
                              <span class="badge costum-badge">
                                  <span class="original-price">RP.33.000.000</span>
                                  <span class="discounted-price">RP.28.000.000</span>
                              </span>
                          </div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                              <h5 class="text-white">Umrah Febuari</h5>
                              <h6 class="text-600">9 days</h6>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/img/paketmaret.jpg" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3">
                              <span class="badge costum-badge">
                                  <span class="original-price">RP.33.000.000</span>
                            ...
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                              <h5 class="text-white">Umrah Maret</h5>
                              <h6 class="text-600">9 days</h6>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="carousel-item">
                    <div class="row h-100">
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/img/paketapril.jpg" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge costum-badge">RP.33.000.000</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                              <h5 class="text-white">Umrah April</h5>
                              <h6 class="text-600">9 days</h6>
                            </div>
                          </div>
                        </div>
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">Shop</h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
              <p class="mx-auto">Belanjakan peralatan Umrahmu.</p>
            </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="carousel slide" id="carouselCategory" data-bs-touch="false" data-bs-interval="false">
                    ...
                    <div class="carousel-item active" data-bs-interval="10000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img class="img-fluid" src="assets/img/gallery/koper.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Suitcase</h5>
                            </div>
                          </div>
                        </div>
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                  ...
                  <div class="row mt-4">
                    ...
                    <!-- Tombol "Lihat Semua" -->
                    <a href="shop.php" class="btn btn-outline-primary position-absolute start-50 translate-middle-x" style="width: auto; white-space: nowrap; font-size: 14px; padding: 5px 10px; top: 100%;">Lihat Semua</a>
                  </div>                                    
                </div>
              </div>
            </div>
      ...
      <section id="booking">
        <div class="bg-holder" style="background-image:url(assets/img//gallery/download.jpg);background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
          ...
          <div class="row flex-center">
            <div class="col-auto mb-4">
              <ul class="list-unstyled list-inline mb-0">
                ...
                <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="#places">Destinations</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="#shop">Shop</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="#booking">Booking</a></li>
              </ul>
            </div>
          </div>
          <div class="row flex-center">
            <div class="col-auto">
              <ul class="list-unstyled list-inline">
                ...
                <li class="list-inline-item me-3"><a class="text-decoration-none" href="#!">
                    <svg class="bi bi-facebook" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
                      <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
                    </svg></a></li>
                <li class="list-inline-item me-3"><a href="#!">
                    <svg class="bi bi-twitter" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
                      <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"></path>
                    </svg></a></li>
                <li class="list-inline-item me-3"><a href="#!">
                    <svg class="bi bi-instagram" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
